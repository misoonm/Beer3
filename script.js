// قاعدة بيانات المستخدمين الافتراضيين
const DEFAULT_USERS = [
    ...
    loginContainer.innerHTML = `
        <div class="login-form">
            ...
            <div class="login-footer">
                ...
                <ul>
                    <li><strong>admin/admin123</strong> (مدير)</li>
                    <li><strong>user/user123</strong> (مستخدم)</li>
                </ul>
            </div>
        </div>
    `;
    
    // إضافة النماذج إلى body إذا لم تكن موجودة
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', function(e) {
            ...
            if (authenticateUser(username, password)) {
                ...
                // إظهار رسالة ترحيب
                showSuccess(`مرحباً ${currentUser.username}!
...
function updateUIForUserRole() {
    if (currentUser && currentUser.role === 'user') {
        // إخفاء الأزرار التي لا يصلح لها المستخدم العادي
